            ...
            <div className="flex items-center justify-between">
               ...
               {!showResults ? (
                  <div className="flex items-center gap-2 sm:gap-4">
                     ...
                     <div className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border-2 transition-colors ${isUrgent
               ...
               <div className="flex space-x-2">
                  {examData.parts.map((part, idx) => (
                     <button
                        ...
                        className={`whitespace-nowrap px-4 py-1.5 text-xs font-bold rounded-full transition-colors ${activePartIndex === idx ? 'bg-emerald-600 text-white' : 'bg-gray-100 text-gray-500 hover:bg-gray-200'
                           }`}
                     >
      ...
      <div className="space-y-6">
         ...
         <div className="space-y-6">
            {part.items.map((item) => {
               ...
               return (
                  <div key={qId} className={`bg-white rounded-2xl p-4 shadow-sm border-2 transition-all ${showResults ? (isCorrect ? 'border-green-400' : 'border-red-400') : 'border-transparent'
                     }`}>
